...
<body>
    ...
    <div class="auth-container">
        <div class="auth-box">
            ...
            <form id="loginForm" class="auth-form" method="POST" action="procesar_login.php">
                ...
                <div class="form-footer">
                    ...
                    <a href="register.php" class="link-alt">Regístrate Aquí</a>
                </div>
            </form>
        </div>
    </div>
